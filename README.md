...
#### 1.1 Pain Part - Syntaxnet is a RESEARCH MODEL:
<hr/>
...
## 2.1 One line (~5mins) SyntaxNet 0.2 installation
...
#### 4.1 Sample output for “Bob brought the pizza to Alice” input
